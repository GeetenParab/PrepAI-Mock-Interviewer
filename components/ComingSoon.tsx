...
export default function ComingSoon() {
  ...
  const solutions = [
    ...
    },
    {
      ...
      description: "Receive instant, actionable insights based on real-time speech analysis. PrepAI fills the gap left by real companies giving users the feedback they never get after real interviews."
    },
    {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Solutions Section */}
          <div className="mb-20">
            <h2 className="text-3xl sm:text-4xl font-bold text-center text-white mb-4">How PrepAI Solves This</h2>
          ...
          <div className="text-center mb-16">
            <div className="max-w-4xl mx-auto bg-gradient-to-r from-red-600/20 to-orange-600/20 backdrop-blur-sm rounded-2xl p-8 sm:p-12 border border-red-400/30">
              <blockquote className="text-xl sm:text-2xl lg:text-3xl font-bold text-white leading-tight space-y-4">
                ...
                <p>PrepAI is built to break that pattern — through pressure, practice, and precision feedback.</p>
          ...
          <div className="text-center pb-12">
            <p className="text-gray-400 text-sm mb-4">
              Let&apos;s connect on LinkedIn and stay updated with PrepAI.
            </p>
            <Link 
              href="https://www.linkedin.com/company/prepai/" 
              target="_blank" 
