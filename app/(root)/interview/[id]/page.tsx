...
const Page = async ({ params }: RouteParams) => {
    ...
    const resume = interview.resumeId ? await getResumeById(interview.resumeId) : null;
    const resumeData = resume?.extractedData || undefined;
    ...
    return (
        <>
            ...
            <Agent 
                ...
                structuredQuestions={interview.structuredQuestions}
                resumeData={resumeData}
                targetRole={interview.role}
                targetCompany={interview.targetCompany}
                depthStrategy={interview.depthStrategy}
